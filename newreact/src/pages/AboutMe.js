...
import img from "../pics/circleMe.png";
...
const AboutMe = () => (
  <div className="bg-secondary">
    <div className="container">
      ...
      <img className="mx-auto d-block" alt="Shue" src={img} />

      <h2 className="text-center text-white"> Shue Moua</h2>

      <h3 className="text-center text-white">Full Stack Web Developer</h3>
      <br />
      <p className="text-center text-white"> Hello, my name is Shue Moua. I am an ambitious student pursuing a coding bootcamp certificate at the University of Minnesota, eager
      to contribute developed knowledge in a full stack developer role. I am skilled in Information Technology with 1+ years in technical troubleshooting for a fortune 500 company.
      Adaptable and driven with strong work ethic and ability to thrive in a team-based or individually motivated settings.</p>
      <br />
      <br />
